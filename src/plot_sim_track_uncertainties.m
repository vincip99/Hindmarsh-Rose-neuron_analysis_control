...
% export figures
exportgraphics(fig5, 'figures/fbl_ref_vs_x_track_unc.pdf', 'ContentType','vector');
exportgraphics(fig6, 'figures/fbl_time_series_track_unc.pdf', 'ContentType','vector');
exportgraphics(fig7, 'figures/fbl_control_input_track_unc.pdf', 'ContentType','vector');
exportgraphics(fig8, 'figures/fbl_error_track_unc.pdf', 'ContentType','vector');
...
% export figures
exportgraphics(fig9, 'figures/smc_ref_vs_x_track_unc.pdf', 'ContentType','vector');
exportgraphics(fig10, 'figures/smc_time_series_track_unc.pdf', 'ContentType','vector');
exportgraphics(fig11, 'figures/smc_control_input_track_unc.pdf', 'ContentType','vector');
exportgraphics(fig12, 'figures/smc_error_track_unc.pdf', 'ContentType','vector');
exportgraphics(fig13, 'figures/smc_sigma_track_unc.pdf', 'ContentType','vector');
