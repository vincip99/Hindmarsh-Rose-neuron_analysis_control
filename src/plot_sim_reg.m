...
% export figures
exportgraphics(fig1, 'figures/pid_ref_vs_x_reg.pdf', 'ContentType','vector');
exportgraphics(fig2, 'figures/pid_time_series_reg.pdf', 'ContentType','vector');
exportgraphics(fig3, 'figures/pid_control_input_reg.pdf', 'ContentType','vector');
exportgraphics(fig4, 'figures/pid_error_reg.pdf', 'ContentType','vector');
...
% export figures
exportgraphics(fig5, 'figures/fbl_ref_vs_x_reg.pdf', 'ContentType','vector');
exportgraphics(fig6, 'figures/fbl_time_series_reg.pdf', 'ContentType','vector');
exportgraphics(fig7, 'figures/fbl_control_input_reg.pdf', 'ContentType','vector');
exportgraphics(fig8, 'figures/fbl_error_reg.pdf', 'ContentType','vector');
...
% export figures
exportgraphics(fig9, 'figures/smc_ref_vs_x_reg.pdf', 'ContentType','vector');
exportgraphics(fig10, 'figures/smc_time_series_reg.pdf', 'ContentType','vector');
exportgraphics(fig11, 'figures/smc_control_input_reg.pdf', 'ContentType','vector');
exportgraphics(fig12, 'figures/smc_error_reg.pdf', 'ContentType','vector');
exportgraphics(fig13, 'figures/smc_sigma_reg.pdf', 'ContentType','vector');
